<template>
  <div
    class="max-w-6xl mx-auto p-4 sm:p-6 lg:p-10 grid md:grid-cols-3 gap-8 lg:gap-12 bg-gray-50 min-h-screen"
  >
    <div class="md:col-span-2 flex flex-col gap-6">
      ...
      <div
        v-for="item in cart"
        :key="item.id"
        class="flex flex-col sm:flex-row gap-4 p-4 lg:p-6 bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-shadow border border-gray-100"
      >
        <div class="flex items-center gap-4 flex-grow">
          <img
            :src="item.image"
            :alt="item.name"
            class="w-24 h-24 object-cover rounded-xl border-4 border-gray-100 flex-shrink-0"
          />
        ...
        <div class="flex justify-between items-center sm:w-1/3 sm:min-w-[240px] mt-3 sm:mt-0">
          ...
          >
            <button
              class="px-4 py-2 bg-gray-100 hover:bg-gray-200 font-bold text-xl text-gray-700 disabled:opacity-50"
            ...
            <button
              class="px-4 py-2 bg-gray-100 hover:bg-gray-200 font-bold text-xl text-gray-700"
          ...
          <button
            class="text-red-500 font-medium hover:text-red-700 transition-colors text-sm ml-4"
      ...
      <div
        v-if="cart.length === 0"
        class="text-center p-10 bg-white rounded-xl shadow-inner border-2 border-dashed border-gray-300"
      >
      ...
      <div class="mt-8 pt-6 border-t border-gray-200">
        ...
        <div class="flex flex-wrap gap-4">
          <div
            class="text-sm font-semibold text-gray-700 bg-white p-2 rounded-full border hover:bg-gray-100 transition-colors cursor-pointer"
          >
            Новая коллекция
          </div>
          <div
    ...
    <div
      class="bg-white p-6 lg:p-8 rounded-2xl shadow-2xl border-2 border-black h-fit sticky top-4"
    >
      ...
      <div class="mb-6">
        ...
        <div class="flex gap-2">
          ...
          />
          <button
            class="px-4 py-3 bg-black text-white font-bold rounded-lg hover:bg-gray-800 transition-colors"
          >
            OK
          </button>
        </div>
...
const cart = reactive([
  ...
  {
    id: 1,
    name: 'Air Max 90 Essentials',
    price: 65000,
    quantity: 1,
    image: 'https://via.placeholder.com/150/f05b45/ffffff?text=Air+Max',
  },
  {
    id: 2,
    ...
    price: 32000,
    quantity: 2,
    image: 'https://via.placeholder.com/150/000000/ffffff?text=Hoodie',
  },
  {
    id: 3,
    ...
    price: 8000,
    quantity: 1,
    image: 'https://via.placeholder.com/150/4a4a4a/ffffff?text=Dri-FIT',
  },
])
